...
public class ServiceConfigErrorHandlingTest {
    ...
    private FakeLoadBalancer mockLoadBalancer = mock(FakeLoadBalancer.class, delegatesTo(new FakeLoadBalancer()));
    ...
    public void setUp() throws Exception {
        ...
        when(executorPool.getObject())
                .thenReturn(executor.getScheduledExecutorService());
    ...
    public void emptyAddresses_validConfig_firstResolution_lbNeedsAddress() throws Exception {
        FakeNameResolverFactory nameResolverFactory = new FakeNameResolverFactory.Builder(expectedUri)
        ...
        final class FakeNameResolver extends NameResolver {
            ...
            void resolved() {
                ...
                if (rawServiceConfig != null) {
                    builder.setServiceConfig(serviceConfigParser.parseServiceConfig(rawServiceConfig));
                }
