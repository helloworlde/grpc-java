 ...
 * <p>
 * 用于处理 gRPC 请求的 server 端的 Netty 处理器，所有的事件处理都在 Netty Channel 线程上下文内部处理
 */
class NettyServerHandler extends AbstractNettyHandler {
    ...
    @VisibleForTesting
    static NettyServerHandler newHandler(ChannelPromise channelUnused,
        ...
        Http2ConnectionEncoder encoder = new ListeningDefaultHttp2ConnectionEncoder(connection, frameWriter);
        ...
        return new NettyServerHandler(channelUnused,
                connection,
                transportListener,
                streamTracerFactories,
                transportTracer,
    ...
    private NettyServerHandler(ChannelPromise channelUnused,
