...
public final class HttpConnectProxiedSocketAddress extends ProxiedSocketAddress {
    ...
    private HttpConnectProxiedSocketAddress(SocketAddress proxyAddress,
        ...
        if (proxyAddress instanceof InetSocketAddress) {
            checkState(!((InetSocketAddress) proxyAddress).isUnresolved(), "The proxy address %s is not resolved", proxyAddress);
        }
