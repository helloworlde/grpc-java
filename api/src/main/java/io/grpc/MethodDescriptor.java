...
public final class MethodDescriptor<ReqT, RespT> {
     ...
     * 设置这个方法描述的原始方法名称，仅应当被 Transport 调用
     */
    ...
    public enum MethodType {
         ...
         * 基数和时间关系未知，实现不应该做缓冲假设，并且很大程度上应当和 BIDI_STREAMING 相似
         */
        UNKNOWN;
         ...
         * server to stream.
         * 如果是 UNARY 或者 CLIENT_STREAMING 类型的不允许服务端的流传输的请求则返回 true
         *
         * @since 1.0.0
         */
    ...
    public interface Marshaller<T> {
         ...
         * 根据给定的消息，生成 InputStream 用于写入线路，可能实现的方式产生 KnownLength 的流，提高传输效率
         *
         ...
         * 将给定的 InputStream 解析为声明类型的实例，以便传递给应用代码
         *
     ...
     */
    @Deprecated
    public static <RequestT, ResponseT> MethodDescriptor<RequestT, ResponseT> create(MethodType type,
                                                                                     String fullMethodName,
                                                                                     Marshaller<RequestT> requestMarshaller,
                                                                                     Marshaller<ResponseT> responseMarshaller) {
        return new MethodDescriptor<>(type,
                fullMethodName,
                requestMarshaller,
                responseMarshaller,
                null,
     ...
     * 将请求消息转为 InputStream,返回的流应当被调用者关闭
     *
    ...
    /**
     * Creates a new builder for a {@link MethodDescriptor}.
     * 为 MethodDescriptor 创建新的 Builder
     *
     * @since 1.1.0
     */
    @CheckReturnValue
    public static <ReqT, RespT> Builder<ReqT, RespT> newBuilder(Marshaller<ReqT> requestMarshaller,
                                                                Marshaller<RespT> responseMarshaller) {
        return new Builder<ReqT, RespT>().setRequestMarshaller(requestMarshaller)
     ...
     */
    @CheckReturnValue
    public <NewReqT, NewRespT> Builder<NewReqT, NewRespT> toBuilder(Marshaller<NewReqT> requestMarshaller,
                                                                    Marshaller<NewRespT> responseMarshaller) {
    ...
    public static final class Builder<ReqT, RespT> {
         ...
         * isSafe() == false}.
         * <p>
         * 设置方法是否是幂等的，如果是幂等的，调用多次不会有附加的作用，如果是 false，方法是不安全的
         *
         * @since 1.1.0
         */
         ...
         * 设置方法是否是安全的，如果是，调用任意多次不会有额外作用，同时方法也是幂等的
         *
         * @since 1.1.0
         */
         ...
         * 设置这个方法的请求是否被本地追踪取样保存，如果是 true，被取样的 trace 会被保存在内存中
         *
         * @since 1.8.0
         */
