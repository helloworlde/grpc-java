...
final class ServiceProviders {
     ...
     * 如果不是 Android 平台，返回发现的所有可用的实现
     * 如果是 Android 平台，返回 hardcode 中所有的可用的实现
     * 这个集合按照优先级降序排列
     */
     ...
     * 如果 ClassLoader 是用于 Android 的，则返回 true
     */
     ...
     * 加载硬编码的提供器集合，没有使用 getResource 是因为在 Android 有性能问题
     */
    @VisibleForTesting
